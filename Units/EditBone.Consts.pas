...
const
  ...
  EDITBONE_TITLE_BAR_ENCODING = 3;
  EDITBONE_TITLE_BAR_SPACING2 = 4;
  EDITBONE_TITLE_BAR_HIGHLIGHTER = 5;
  EDITBONE_TITLE_BAR_SPACING3 = 6;
  EDITBONE_TITLE_BAR_COLORS = 7;
  EDITBONE_TITLE_BAR_SPACING4 = 8;
